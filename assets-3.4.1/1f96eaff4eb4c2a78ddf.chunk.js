...
`,M=r.I4.div`
  color: ${({theme:e})=>e.colors.grayscale.dark2};
`,j=(0,g.Ay)((function({addDangerToast:e,addSuccessToast:t,user:a}){const{state:{loading:r,resourceCount:c,resourceCollection:g,bulkSelectEnabled:N},hasPerm:P,fetchData:I,toggleBulkSelect:H,refreshData:L}=(0,y.RU)("saved_query",(0,s.t)("Saved queries"),e),{roles:K}=(0,p.d4)((e=>e.user)),O=(0,Q.L)("can_read","Tag",K),[j,J]=(0,l.useState)(null),[W,V]=(0,l.useState)(null),[G,X]=(0,l.useState)(!1),[Z,ee]=(0,l.useState)([]),[te,ae]=(0,l.useState)(!1),[se,re]=(0,l.useState)([]),[ne,ie]=(0,l.useState)([]),[le,oe]=(0,l.useState)([]),de=(0,o.W6)(),ce=P("can_write"),ue=P("can_write"),he=P("can_write"),pe=P("can_export"),me=(0,l.useCallback)((t=>{n.A.get({endpoint:`/api/v1/saved_query/${t}`}).then((({json:e={}})=>{V({...e.result})}),(0,h.JF)((t=>e((0,s.t)("There was an issue previewing the selected query %s",t)))))}),[e]),ge={activeChild:"Saved queries",...q.F},ye=[];he&&ye.push({name:(0,s.t)("Bulk select"),onClick:H,buttonStyle:"secondary"}),ye.push({name:(0,E.FD)(d.N_,{to:"/sqllab?new=true",children:[(0,E.Y)("i",{className:"fa fa-plus"})," ",(0,s.t)("Query")]}),buttonStyle:"primary"}),ce&&ye.push({name:(0,E.Y)(T.m_,{id:"import-tooltip",title:(0,s.t)("Import queries"),placement:"bottomRight",children:(0,E.Y)($.A.Import,{})}),buttonStyle:"link",onClick:()=>{X(!0)}}),ge.buttons=ye;const be=(a,r)=>{(0,D.A)((()=>Promise.resolve(`${window.location.origin}/sqllab?savedQueryId=${a}`))).then((()=>{t((0,s.t)("Link Copied!"))})).catch((()=>{e((0,s.t)("Sorry, your browser does not support copying."))})),r?window.open(`/sqllab?savedQueryId=${a}`):de.push(`/sqllab?savedQueryId=${a}`)},ve=(0,l.useCallback)((async a=>{try{const e={dbId:a.db_id,name:a.label,schema:a.schema,catalog:a.catalog,sql:a.sql,autorun:!1,templateParams:null},r=await n.A.post({endpoint:"/api/v1/sqllab/permalink",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}),{url:i}=r.json;await navigator.clipboard.writeText(i),t((0,s.t)("Link Copied!"))}catch(t){e((0,s.t)("There was an error generating the permalink."))}}),[e,t]),we=e=>{const t=e.map((({id:e})=>e));(0,v.A)("saved_query",t,(()=>{ae(!1)})),ae(!0)},Se=[{id:"changed_on_delta_humanized",desc:!0}],fe=(0,l.useMemo)((()=>[{accessor:"label",Header:(0,s.t)("Name"),Cell:({row:{original:{id:e,label:t}}})=>(0,E.Y)(d.N_,{to:`/sqllab?savedQueryId=${e}`,children:t})},{accessor:"description",Header:(0,s.t)("Description")},{accessor:"database.database_name",Header:(0,s.t)("Database"),size:"xl"},{accessor:"database",hidden:!0,disableSortBy:!0},{accessor:"schema",Header:(0,s.t)("Schema"),size:"xl"},{Cell:({row:{original:{sql_tables:e=[]}}})=>{const t=e.map((e=>e.table)),a=(null==t?void 0:t.shift())||"";return t.length?(0,E.FD)(B,{children:[(0,E.Y)("span",{children:a}),(0,E.Y)(m.A,{placement:"right",title:(0,s.t)("TABLES"),trigger:"click",content:(0,E.Y)(E.FK,{children:t.map((e=>(0,E.Y)(M,{children:e},e)))}),children:(0,E.FD)("span",{className:"count",children:["(+",t.length,")"]})})]}):a},accessor:"sql_tables",Header:(0,s.t)("Tables"),size:"xl",disableSortBy:!0},{Cell:({row:{original:{tags:e=[]}}})=>(0,E.Y)(_.S,{tags:e.filter((e=>1===e.type))}),Header:(0,s.t)("Tags"),accessor:"tags",disableSortBy:!0,hidden:!(0,i.G7)(i.TO.TaggingSystem)},{Cell:({row:{original:{changed_by:e,changed_on_delta_humanized:t}}})=>(0,E.Y)(F.U,{user:e,date:t}),Header:(0,s.t)("Last modified"),accessor:"changed_on_delta_humanized",size:"xl"},{Cell:({row:{original:e}})=>{const t=[{label:"preview-action",tooltip:(0,s.t)("Query preview"),placement:"bottom",icon:"Binoculars",onClick:()=>{me(e.id)}},ue&&{label:"edit-action",tooltip:(0,s.t)("Edit query"),placement:"bottom",icon:"Edit",onClick:({metaKey:t})=>be(e.id,Boolean(t))},{label:"copy-action",tooltip:(0,s.t)("Copy query URL"),placement:"bottom",icon:"Copy",onClick:()=>ve(e)},pe&&{label:"export-action",tooltip:(0,s.t)("Export query"),placement:"bottom",icon:"Share",onClick:()=>we([e])},he&&{label:"delete-action",tooltip:(0,s.t)("Delete query"),placement:"bottom",icon:"Trash",onClick:()=>J(e)}].filter((e=>!!e));return(0,E.Y)(A.A,{actions:t})},Header:(0,s.t)("Actions"),id:"actions",disableSortBy:!0},{accessor:k.H.ChangedBy,hidden:!0}]),[he,ue,pe,ve,me]),xe=(0,l.useMemo)((()=>[{Header:(0,s.t)("Search"),id:"label",key:"search",input:"search",operator:S.t.AllText,toolTipDescription:"Searches all text fields: Name, Description, Database & Schema"},{Header:(0,s.t)("Database"),key:"database",id:"database",input:"select",operator:S.t.RelationOneMany,unfilteredLabel:(0,s.t)("All"),fetchSelects:(0,h.u1)("saved_query","database",(0,h.JF)((t=>e((0,s.t)("An error occurred while fetching dataset datasource values: %s",t))))),paginate:!0},{Header:(0,s.t)("Schema"),id:"schema",key:"schema",input:"select",operator:S.t.Equals,unfilteredLabel:"All",fetchSelects:(0,h.$C)("saved_query","schema",(0,h.JF)((t=>e((0,s.t)("An error occurred while fetching schema values: %s",t))))),paginate:!0},...(0,i.G7)(i.TO.TaggingSystem)&&O?[{Header:(0,s.t)("Tag"),id:"tags",key:"tags",input:"select",operator:S.t.SavedQueryTagById,fetchSelects:C.m}]:[],{Header:(0,s.t)("Modified by"),key:"changed_by",id:"changed_by",input:"select",operator:S.t.RelationOneMany,unfilteredLabel:(0,s.t)("All"),fetchSelects:(0,h.u1)("saved_query","changed_by",(0,h.JF)((e=>(0,s.t)("An error occurred while fetching dataset datasource values: %s",e))),a),paginate:!0}]),[e]);return(0,E.FD)(E.FK,{children:[(0,E.Y)(w.A,{...ge}),j&&(0,E.Y)(x.A,{description:(0,s.t)("This action will permanently delete the saved query."),onConfirm:()=>{j&&(({id:a,label:r})=>{n.A.delete({endpoint:`/api/v1/saved_query/${a}`}).then((()=>{L(),J(null),t((0,s.t)("Deleted: %s",r))}),(0,h.JF)((t=>e((0,s.t)("There was an issue deleting %s: %s",r,t)))))})(j)},onHide:()=>J(null),open:!0,title:(0,s.t)("Delete Query?")}),W&&(0,E.Y)(R,{fetchData:me,onHide:()=>V(null),savedQuery:W,queries:g,openInSqlLab:be,show:!0}),(0,E.Y)(b.A,{title:(0,s.t)("Please confirm"),description:(0,s.t)("Are you sure you want to delete the selected queries?"),onConfirm:a=>{n.A.delete({endpoint:`/api/v1/saved_query/?q=${u().encode(a.map((({id:e})=>e)))}`}).then((({json:e={}})=>{L(),t(e.message)}),(0,h.JF)((t=>e((0,s.t)("There was an issue deleting the selected queries: %s",t)))))},children:a=>{const n=(0,i.G7)(i.TO.TaggingSystem),l=[];return he&&l.push({key:"delete",name:(0,s.t)("Delete"),onSelect:a,type:"danger"}),pe&&l.push({key:"export",name:(0,s.t)("Export"),type:"primary",onSelect:we}),(0,E.Y)(S.A,{className:"saved_query-list-view",columns:fe,count:c,data:g,fetchData:I,filters:xe,initialSort:Se,loading:r,pageSize:25,bulkActions:l,addSuccessToast:t,addDangerToast:e,bulkSelectEnabled:N,disableBulkSelect:H,highlightRowId:null==W?void 0:W.id,enableBulkTag:n,bulkTagResourceName:"query",refreshData:L})}}),(0,E.Y)(Y.A,{resourceName:"saved_query",resourceLabel:(0,s.t)("queries"),passwordsNeededMessage:U,confirmOverwriteMessage:z,addDangerToast:e,addSuccessToast:t,onModelImport:()=>{X(!1),L(),t((0,s.t)("Query imported"))},show:G,onHide:()=>{X(!1)},passwordFields:Z,setPasswordFields:ee,sshTunnelPasswordFields:se,setSSHTunnelPasswordFields:re,sshTunnelPrivateKeyFields:ne,setSSHTunnelPrivateKeyFields:ie,sshTunnelPrivateKeyPasswordFields:le,setSSHTunnelPrivateKeyPasswordFields:oe}),te&&(0,E.Y)(f.A,{})]})}))}}]);